# home-crew-admin-service

Administrative operations over users, workers and bookings.
...
|---|---|
| Port | 8083 |
| Route through the gateway | `/admin/**` |
| Java package | `com.homecrew.adminservice` |
| Maven artifact | `adminservice` |
| Image | `mthanuj/homecrew-admin-service:dev` |
| Compose service | `admin-service` |
| Database | `homecrew_admin` |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-admin-service:dev
    mthanuj/homecrew-admin-service:sha-<short>
